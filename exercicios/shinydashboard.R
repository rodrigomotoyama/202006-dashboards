...
ui <- dashboardPage(
  dashboardHeader(title = "Crimes SP"),
  dashboardSidebar(
    sidebarMenu(
      menuItem("Estado de São Paulo", tabName = "estado"),
      menuItem("Municípios", tabName = "municipio")
    )
  ),
  dashboardBody(
    tabItems(
      tabItem(
        tabName = "estado",
        h1("Crimes no estado de São Paulo"),
        selectInput(
          inputId = "crime",
      ...
      tabItem(
        tabName = "municipio",
        h1("Crimes por município de São Paulo"),
        selectInput(
          inputId = "crime_serie",
          label = "Selecione o crime",
          choices = col_crime
